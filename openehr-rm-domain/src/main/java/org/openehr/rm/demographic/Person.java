...
public class Person extends Actor {
	 ...
	 *             empty, or uid is null, or identities is null, or empty, or
	 *             contacts is empty, or no legal identity, or empty roles or
	 *             empty languages
	 */
	@FullConstructor
	public Person(
			...
			@Attribute(name = "identities") Set<PartyIdentity> identities,
 ...
 * 
 * The Initial Developer of the Original Code is Goran Pestana. Portions created
 * by the Initial Developer are Copyright (C) 2003-2005 the Initial Developer.
 * All Rights Reserved.
 * 
 * Contributor(s):
 * 
