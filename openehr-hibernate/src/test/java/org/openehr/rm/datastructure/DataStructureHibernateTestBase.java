...
public abstract class DataStructureHibernateTestBase extends AbstractHibernateTest {
    ...
    protected DvText text(String value) {
        return new DvText(value, new CodePhrase(new TerminologyID("language-test"), "english"),
                new CodePhrase(new TerminologyID("charset-test"), "ISO-8859-1"),
    ...
    protected DvCodedText codedText(String value, String code) {
        CodePhrase codePhrase =
                new CodePhrase(new TerminologyID("snomedct-test"), code);
        return new DvCodedText(value, new CodePhrase(new TerminologyID("language-test"), "english"),
        		new CodePhrase(new TerminologyID("charset-test"), "ISO-8859-1"), codePhrase,
                TestTerminologyService.getInstance());
    }
